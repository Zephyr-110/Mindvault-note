package org.example.mindvaultaiservice.client;
...
import org.example.mindvaultaiapi.dto.ChatRequestDTO;
import org.example.mindvaultaiapi.dto.ChatResponseDTO;
import org.example.mindvaultaiapi.dto.RerankDTO;
...
public class PythonAIClient {
    ...
    public ChatResponseDTO chat(ChatRequestDTO request) {
        return toJson("/api/ai/chat", request, ChatResponseDTO.class);
    }

    public SseEmitter chatStream(ChatRequestDTO request,  Consumer<String> onComplete) {
        return toStream("/api/ai/stream_chat", request, onComplete);
    }

    public SseEmitter rerank(RerankDTO request,  Consumer<String> onComplete) {
        return toStream("/api/ai/rerank", request, onComplete);
    }
    ...
    private <T> T toJson(String path, Object body, Class<T> responseType) {
        String json ;
        //这里可能会报序列化异常
        try {
            //将DTO对象序列化为JSON字符串
    ...
    private SseEmitter toStream(String path, Object body, Consumer<String> onComplete){
        String json ;
        //这里可能会报序列化异常
        try {
            //将DTO对象序列化为JSON字符串
